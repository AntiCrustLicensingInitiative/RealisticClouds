...
object WorldRendererMixinKt {
    ...
    private fun spawnCloud(world: ClientWorld, x: Int, z: Int) {
        ...
        renderCloud(x.toDouble(), y.toDouble(), z.toDouble(), 1-transparency)
    }
    ...
    private fun renderCloud(x: Double, y: Double, z: Double, transparency: Float) {
        ...
        val z = 0.0
        // Face 1 (x, y)
        builder.vertex(x,y,z).color(1f, 1f, 1f, transparency).next()
        builder.vertex(x+1,y,z).color(1f, 1f, 1f, transparency).next()
        builder.vertex(x+1,y+1,z).color(1f, 1f, 1f, transparency).next()
        builder.vertex(x,y+1,z).color(1f, 1f, 1f, transparency).next()
        // Face 2 (x, y, +1)
        builder.vertex(x,y,z+1).color(1f, 1f, 1f, transparency).next()
        builder.vertex(x+1,y,z+1).color(1f, 1f, 1f, transparency).next()
        builder.vertex(x+1,y+1,z+1).color(1f, 1f, 1f, transparency).next()
        builder.vertex(x,y+1,z+1).color(1f, 1f, 1f, transparency).next()
        // Face 3 (x, z)
        builder.vertex(x,y,z).color(1f, 1f, 1f, transparency).next()
        builder.vertex(x+1,y,z).color(1f, 1f, 1f, transparency).next()
        builder.vertex(x+1,y,z+1).color(1f, 1f, 1f, transparency).next()
