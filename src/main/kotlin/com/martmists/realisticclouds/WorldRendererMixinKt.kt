...
object WorldRendererMixinKt {
    ...
    private fun renderCloud(x: Double, y: Double, z: Double, transparency: Float) {
        ...
        builder.vertex(x+1,y,z).color(255, 255, 255, transparency).next()
        builder.vertex(x+1,y+1,z).color(255, 255, 255, transparency).next()
        builder.vertex(x,y+1,z).color(255, 255, 255, transparency).next()
        // Face 2 (x, y, +1)
        builder.vertex(x,y,z+1).color(255, 255, 255, transparency).next()
        builder.vertex(x+1,y,z+1).color(255, 255, 255, transparency).next()
        builder.vertex(x+1,y+1,z+1).color(255, 255, 255, transparency).next()
        builder.vertex(x,y+1,z+1).color(255, 255, 255, transparency).next()
        // Face 3 (x, z)
        builder.vertex(x,y,z).color(255, 255, 255, transparency).next()
        builder.vertex(x+1,y,z).color(255, 255, 255, transparency).next()
        builder.vertex(x+1,y,z+1).color(255, 255, 255, transparency).next()
